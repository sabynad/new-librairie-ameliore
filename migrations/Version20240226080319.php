 ...
 */
final class Version20240226080319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8');
        ...
        $this->addSql('ALTER TABLE commander DROP FOREIGN KEY commander_ibfk_1');
        $this->addSql('ALTER TABLE commander DROP FOREIGN KEY commander_ibfk_2');
        $this->addSql('ALTER TABLE commander DROP idUtilisateur, CHANGE Date_achat date_achat DATE NOT NULL, CHANGE Prix_achat prix_achat VARCHAR(50) NOT NULL, CHANGE Nbr_exemplaires nbr_exemplaires VARCHAR(50) NOT NULL');
        ...
        $this->addSql('ALTER TABLE fournisseurs CHANGE Code_fournisseur code_fournisseur VARCHAR(50) NOT NULL, CHANGE Raison_sociale raison_sociale VARCHAR(50) NOT NULL, CHANGE Rue_fournisseur rue_fournisseur VARCHAR(50) NOT NULL, CHANGE Code_postal code_postal VARCHAR(50) DEFAULT NULL, CHANGE Localite localite VARCHAR(50) NOT NULL, CHANGE Pays pays VARCHAR(50) NOT NULL, CHANGE Tel_fournisseur tel_fournisseur VARCHAR(50) DEFAULT NULL, CHANGE Url_fournisseur url_fournisseur VARCHAR(50) NOT NULL, CHANGE Email_fournisseur email_fournisseur VARCHAR(50) NOT NULL, CHANGE Fax_fournisseur fax_fournisseur VARCHAR(50) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE livres CHANGE Titre_livre titre_livre VARCHAR(50) NOT NULL, CHANGE Nbr_pages_livre nbr_pages_livre VARCHAR(255) NOT NULL, CHANGE Nom_auteur nom_auteur VARCHAR(50) NOT NULL, CHANGE Prenom_auteur prenom_auteur VARCHAR(50) NOT NULL, CHANGE Editeur editeur VARCHAR(50) NOT NULL, CHANGE Annee_edition annee_edition VARCHAR(50) NOT NULL, CHANGE Prix_vente prix_vente VARCHAR(50) NOT NULL');
        ...
        $this->addSql('ALTER TABLE utilisateur ADD md_p VARCHAR(50) DEFAULT NULL, DROP MdP, CHANGE nom nom VARCHAR(50) DEFAULT NULL, CHANGE prenom prenom VARCHAR(50) DEFAULT NULL, CHANGE age age BIGINT DEFAULT NULL, CHANGE Date date VARCHAR(50) NOT NULL, CHANGE Statut statut VARCHAR(50) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commander DROP FOREIGN KEY FK_42D318BA7A5143FB');
        $this->addSql('ALTER TABLE commander DROP FOREIGN KEY FK_42D318BAE3E87F1D');
        $this->addSql('ALTER TABLE commander ADD idUtilisateur INT NOT NULL, CHANGE date_achat Date_achat DATE DEFAULT \'CURRENT_TIMESTAMP\' NOT NULL, CHANGE prix_achat Prix_achat NUMERIC(6, 2) NOT NULL, CHANGE nbr_exemplaires Nbr_exemplaires INT NOT NULL');
        $this->addSql('ALTER TABLE commander ADD CONSTRAINT commander_ibfk_1 FOREIGN KEY (Id_Livre) REFERENCES livres (Id_Livre) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE commander ADD CONSTRAINT commander_ibfk_2 FOREIGN KEY (Id_fournisseur) REFERENCES fournisseurs (Id_fournisseur) ON UPDATE CASCADE ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE livres CHANGE titre_livre Titre_livre VARCHAR(100) NOT NULL, CHANGE nbr_pages_livre Nbr_pages_livre INT NOT NULL, CHANGE nom_auteur Nom_auteur VARCHAR(100) NOT NULL, CHANGE prenom_auteur Prenom_auteur VARCHAR(100) NOT NULL, CHANGE editeur Editeur VARCHAR(100) NOT NULL, CHANGE annee_edition Annee_edition INT NOT NULL, CHANGE prix_vente Prix_vente NUMERIC(6, 2) NOT NULL');
        ...
        $this->addSql('ALTER TABLE utilisateur ADD MdP VARCHAR(32) DEFAULT NULL, DROP md_p, CHANGE nom nom VARCHAR(20) DEFAULT NULL, CHANGE prenom prenom VARCHAR(20) DEFAULT NULL, CHANGE age age INT DEFAULT NULL, CHANGE date Date DATE DEFAULT \'CURRENT_TIMESTAMP\' NOT NULL, CHANGE statut Statut VARCHAR(50) DEFAULT \'Utilisateur\'');
